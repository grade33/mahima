...
import {
  files
} from "./gulp/tasks/files.js";
import {
  markup
} from "./gulp/tasks/markup.js";
import {
  markupBackend
} from "./gulp/tasks/markup.js";
import {
...
const mainTasksBackend = gulp.series(fonts, images, gulp.parallel(files, markupBackend, stylesBackend, scriptsBackend, sprite))
